"""
Iteration 40: BTC MVRV Trend Entry Gate — 5-Coin Portfolio (adds TRX)
======================================================================
Extends Iter 34 (MVRV trend gate, 7/7 PASS at +2.55%/mo) by adding TRX as a
5th portfolio coin. TRX returned +844% in OOS 2021-2024 vs ADA's +380%, while
IS 2020 was +104% (vs ADA +444%). Adding TRX should boost OOS returns.
...
def main():
    print("\n" + "=" * 72)
    print("  ITERATION 40 — BTC MVRV Trend Gate | 5-Coin Portfolio (BTC+ETH+BNB+ADA+TRX)")
    ...
    champ_rpt.print_full_report(
        f"OOS CHAMPION — Iter 40 MVRV Trend Gate (5-Coin: BTC+ETH+BNB+ADA+TRX)"
