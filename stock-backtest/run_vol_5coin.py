"""
Iteration 41: BTC Realized Volatility Entry Gate — 5-Coin Portfolio (adds TRX)
================================================================================
...
def main():
    print("\n" + "=" * 72)
    print("  ITERATION 41 — BTC Realized Vol Gate + 5-Coin Portfolio (adds TRX)")
    ...
    champ_rpt.print_full_report(
        f"OOS CHAMPION — Vol Gate 5-Coin"
