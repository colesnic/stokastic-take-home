"""
Iteration 54: BTC Realized Volatility Entry Gate — 5-Coin Portfolio (DOGE replaces TRX)
================================================================================
...
class VolGate5CoinDOGEStrategy:
    """
...
def run_is(full_data, is_data, btc_full, eth_full, sp, bt_fixed):
    strat = VolGate5CoinDOGEStrategy(**sp)
...
def main():
    print("\n" + "=" * 72)
    print("  ITERATION 54 — BTC Realized Vol Gate + 5-Coin Portfolio (DOGE replaces TRX)")
    ...
    champ_rpt.print_full_report(
        f"OOS CHAMPION — Vol Gate 5-Coin DOGE"
